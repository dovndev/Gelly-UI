...
import { GlassCard } from "@glass-ui/core";
...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-900/80 to-black/80 text-white p-10 flex flex-col gap-16 items-center">
      {/* Hero Section */}
      <GlassCard className="text-center p-10 max-w-2xl">
        <h1 className="text-4xl font-bold mb-4">Welcome to <span className="text-blue-400">Glass UI</span></h1>
      ...
      {/* Footer */}
      <GlassCard className="text-sm text-center text-gray-400 py-4 px-6">
        Made with ❤️ using Glass UI – © {new Date().getFullYear()}
      </GlassCard>
    </main>
  );
}
