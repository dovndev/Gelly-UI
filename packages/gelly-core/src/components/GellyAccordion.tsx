...
export interface GellyAccordionItem {
  title: React.ReactNode;
  content: React.ReactNode;
}

export interface GellyAccordionProps {
  items: GellyAccordionItem[];
  className?: string;
}

export const GellyAccordion: React.FC<GellyAccordionProps> = ({
  items,
  className,
}) => {
